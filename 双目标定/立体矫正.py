...
while True:
    ...
    # 拼接左右图像
    concatenated_img = cv2.hconcat([left_undistorted, right_undistorted])

    # 添加水平线，用于评估矫正效果
    # 在图像的中间添加水平线
    middle_height = height // 2
    cv2.line(concatenated_img, (0, middle_height), (concatenated_img.shape[1], middle_height), (0, 255, 0), 2)

    # 显示拼接后的图像
    cv2.imshow("Left and Right Images", concatenated_img)
